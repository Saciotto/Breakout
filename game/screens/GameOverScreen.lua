...
function GameOverScreen:load()
    ...
    local gameOverLabel = Label:new("Game Over", Colors.WHITE, Fonts.CHILANKA, 60, 0, 20, Constants.SCREEN_WIDTH)
    gameOverLabel:setAlign("center", "top")

    local text  = "Final score: " .. GameData.score .. "\n"
    text = text .. "Max. score: " .. GameData.maxScore

    local label = Label:new(text, Colors.BLUE, Fonts.CHILANKA, 60, 0, 130, Constants.SCREEN_WIDTH)
